  ...
  const team = [
    {
      ...
      firstName: 'MANTHAN',
      lastName: 'DONGA',
      role: 'LEAD MENTOR & PROGRAM MANAGEMENT & COORDINATOR',
      initials: 'MD',
      color: '#F97316',
      gradient: 'from-[#F97316] to-red-500',
      bio: [
        "Great content starts with the right mindset. Manthan brings the vision, motivation, learning and direction that connects the entire Banaviye Brand experience.",
      ],
      quote: "Learning means nothing until you have the courage to turn it into action.",
    ...
    },
    {
      ...
      firstName: 'VIVEK',
      lastName: 'VAGHASIYA',
      role: 'SOCIAL MEDIA, SHOOTING & EDITING MENTOR',
      initials: 'VV',
      color: '#3B82F6',
      gradient: 'from-[#3B82F6] to-green-500',
      bio: [
        "Great content needs more than a camera. Vivek brings practical knowledge of social media, shooting and editing to help participants turn ideas into engaging short-form content.",
      ],
    ...
    },
    {
      ...
      firstName: 'JAYDIP',
      lastName: 'TALAVIYA',
      role: 'META & CONTENT STRATEGY MENTOR',
      initials: 'JT',
      color: '#00D4E8',
      gradient: 'from-[#00D4E8] to-blue-500',
      bio: [
        "Great content starts before you press record. Jaydip brings strategy, research and content thinking to help participants understand what to create, when to create it and how content builds a brand.",
      ],
    ...
    },
    {
      ...
      firstName: 'KULDEEP',
      lastName: 'VAGHASIYA',
      role: 'PROGRAM MANAGEMENT & EXECUTION & SPEAKER',
      initials: 'KV',
      color: '#A78BFA',
